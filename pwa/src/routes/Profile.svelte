<script lang="typescript">
  ...
  function exampleGreeting(name: string): Block[] {
    return [
      {
        type: "paragraph",
        spans: [
          {
            type: "text",
            text: "Hi, thanks for reaching out to me.",
          },
        ],
      },
      {
        ...
        spans: [
          {
            type: "text",
            text:
              "I am trying out Memo to spend less time in my inbox and have more productive conversations. To help me get started would you mind giving me a bit of context about your query.",
          },
        ],
      },
      {
        ...
        spans: [
          {
            type: "text",
            text:
              "Do you need an answer quickly, in which case please start with your question?",
          },
        ],
      },
      {
        ...
        spans: [
          {
            type: "text",
            text:
              "How do I know you, can you share a public profile, e.g. twitter?",
          },
        ],
      },
      {
  ...
  let original = greetingEmpty
    ? exampleGreeting(identifier.name || "")
    : identifier.greeting || [];
</script>

<main class="w-full mx-auto md:max-w-3xl px-1 md:px-2">
  <article class="my-4 py-2 px-6 md:px-12 bg-white rounded shadow">
    ...
    {#if greetingEmpty}
      ...
      <div class="">
        <p class="my-2">
          The greeting below is an example and will not be shared with anyone
          until you save it. Feel free to edit as you like, or clear and start
          over.
        </p>
      </div>
    {:else}
    ...
    <a
      ...
      href="https://facebook.com/sharer/sharer.php?u={window.location
        .origin}{conversation_module.url(identifier)}"
      target="_blank"
      rel="noopener"
      aria-label="Facebook"
    >
    ...
    <a
      ...
      href="https://twitter.com/intent/tweet/?text=I'm trying out Memo to control my inbox, why not say hi&url={window
        .location.origin}{conversation_module.url(identifier)}"
      target="_blank"
      rel="noopener"
      aria-label="Twitter"
    >
  ...
  <div class="inline-flex pr-2 mr-2 items-center">
    ...
    <a
      class="resp-sharing-button__link"
      href="https://news.ycombinator.com/submitlink?u={window.location
        .origin}{conversation_module.url(
        identifier
      )}&amp;t=I'm trying out Memo to control my inbox, why not say hi"
      target="_blank"
      rel="noopener"
