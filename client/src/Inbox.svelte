...
<header class="z-20 h-16 fixed w-full bg-white text-left border-b-2">
  <nav class="ml-auto p-4">
    <a href="/">
      <span class="px-1 mr-8 hover:text-indigo-800 hover:border-indigo-800 pt-2 text-lg font-semibold">**user-id**</span>
    </a>
    <a style="padding-top:0.28em; padding-bottom:0.5em;" class="bg-green-500 hover:bg-green-700 transition duration-200 px-4 rounded-lg text-white leading-none" href="#begin">
      <svg style="margin-bottom:0.1em;" class="fill-current w-6 mr-2 inline leading-none" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1" id="Capa_1" x="0px" y="0px" viewBox="0 0 512 512" style="enable-background:new 0 0 512 512;" xml:space="preserve">
        <g>
          <g>
    ...
    <p class="ml-8 inline text-xs text-gray-700">
      {#if unread.length}
      <a class="px-1 border-b-2 border-white {panel === UNREAD ? 'text-indigo-800' : ''} hover:text-indigo-800 hover:border-indigo-800" href="#unread">Unread</a>
      {/if}
      <a class="px-1 border-b-2 border-white {panel === SEARCH ? 'text-indigo-800' : ''} hover:text-indigo-800 hover:border-indigo-800" href="#">Search</a>
      <a class="px-1 border-b-2 border-white {panel === ARCHIVE ? 'text-indigo-800' : ''} hover:text-indigo-800 hover:border-indigo-800" href="#archive">Archive</a>
      <a class="px-1 border-b-2 border-white hover:text-indigo-800 hover:border-indigo-800" href="__API_ORIGIN__/sign_out">Sign out</a>
    </p>   
  </nav>
</header>
